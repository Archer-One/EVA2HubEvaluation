...
public class Util {
    ...
    //此方法返回一个模数范围内的256位的随机值
    public static BigInteger getRandom() {
        final BigInteger FIELD_MODULUS = new BigInteger("21888242871839275222246405745257275088548364400416034343698204186575808495617");
    ...
    public static BigInteger getNegate(BigInteger x){
        BigInteger q = new BigInteger("21888242871839275222246405745257275088548364400416034343698204186575808495617");
        return x.negate().mod(q);
    }
